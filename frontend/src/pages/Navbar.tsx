...
interface NavbarProps {
  onLogout: () => void;
  catalogMode?: boolean; // <-- agregado
}

export default function Navbar({ onLogout, catalogMode = false }: NavbarProps) {
  ...
  const links = [
    ...
    { name: "Catalogo", path: "/catalogo-productos" },
  ];
    ...
    <nav className="backdrop-blur-md bg-gray-900/90 shadow-lg sticky top-0 z-50 border-b border-gray-700">
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          {/* Links escritorio — ocultos en modo catálogo */}
          {!catalogMode && (
          ...
          {/* Botón menú móvil — oculto en modo catálogo */}
          {!catalogMode && (
      ...
      {/* Menú móvil — oculto en modo catálogo */}
      {!catalogMode && isOpen && (
